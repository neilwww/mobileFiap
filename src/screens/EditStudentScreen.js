...
const EditStudentScreen = ({ route, navigation }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await mockAPI.updateStudent(studentId, {
        name: name.trim(),
      ...
      Alert.alert('Erro', error.message || 'Não foi possível atualizar o estudante');
    } finally {
      setSaving(false);
    }
  };
  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Carregando dados do estudante...</Text>
      </View>
    );
  }
        ...
        <Card style={styles.card}>
          <Card.Content>
            <View style={styles.cardHeader}>
              ...
              <Title style={styles.cardTitle}>Editar Estudante</Title>
            </View>
