...
const EditPostScreen = ({ route, navigation }) => {
  ...
  const loadPost = async () => {
    try {
      setLoading(true);
      const post = await mockAPI.getPostById(postId);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await mockAPI.updatePost(postId, {
        title: title.trim(),
      ...
      Alert.alert('Erro', error.message || 'Não foi possível atualizar o post');
    } finally {
      setSaving(false);
    }
  };
    ...
    >
      <ScrollView style={styles.scrollView}>
        <Card style={styles.card}>
          <Card.Content>
            <Title style={styles.cardTitle}>Editar Post</Title>
            ...
            <View style={styles.buttonContainer}>
              ...
              <Button
                ...
                disabled={saving || !title.trim() || !content.trim() || !description.trim()}
              >
                {saving ? (
